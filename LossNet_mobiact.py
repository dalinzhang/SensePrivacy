...
num_features = 9 # attitude(roll, pitch, yaw); gravity(x, y, z); rotationRate(x, y, z); userAcceleration(x,y,z)
...
train_ts, test_ts = creat_time_series(num_features, num_act_labels, num_gen_labels, label_codes, trial_codes, num_id_labels = num_id_labels)
...
# 
# lossnet_model.save('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/lossnet.h5')
...
gender_model.save('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/gender_net.h5')
...
# 
# id_model.save('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/id_net.h5')
# 
# 
# '''
# weight_net
...
# 
# wei_model.save('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/wei_net.h5')
...
# print("**** mae for height Recognition task is: ", results_1[2])
# 
# hei_model.save('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/hei_net.h5')
...
# print("**** mae for age Recognition task is: ", results_1[2])
# 
# age_model.save('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/age_net.h5')
...
lossnet_model = load_model('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/lossnet.h5')
