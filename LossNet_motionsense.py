...
# 
# lossnet_model.save_weights('./saved_model/lossnet_weights.h5')
# lossnet_model.save('./saved_model/lossnet.h5')
...
# 
# gender_model.save('./saved_model/gender_net.h5')
...
id_model.save('./saved_model/id_net.h5')
...
# print("**** mae for weight Recognition task is: ", results_1[2])
# 
# wei_model.save('./saved_model/wei_net.h5')
...
# print("**** mae for height Recognition task is: ", results_1[2])
# 
# hei_model.save('./saved_model/hei_net.h5')
...
# print("**** mae for age Recognition task is: ", results_1[2])
# 
# age_model.save('./saved_model/age_net.h5')

# preliminary study
# use feature of loss net to train an one layer MLP 

'''
load model and predict with 1-layer MLP
'''
...
X_test = test_layer_outs[6][0].reshape(test_data.shape[0], -1)
X_train = train_layer_outs[6][0].reshape(train_data.shape[0], -1)
...
print("**** Accuracy for Activity Recognition task of conv2_2 is: ", results_pre[1])
'''
