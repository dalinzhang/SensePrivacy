...
lossnet = load_model(save_dir + 'lossnet.h5')
...
gennet = load_model(save_dir + 'gender_net.h5')
gennet.trainable = False
heinet = load_model(save_dir + 'hei_net.h5')
heinet.trainable = False
weinet = load_model(save_dir + 'wei_net.h5')
weinet.trainable = False
agenet = load_model(save_dir + 'age_net.h5')
agenet.trainable = False
idnet = load_model(save_dir + 'id_net.h5')
