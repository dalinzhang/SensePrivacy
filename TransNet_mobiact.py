...
import pandas as pd
from loss import *
from load_mobiact import *
##_____________________________

sub_info = "/home/dadafly/program/SensePrivacy/MobiAct/data/data_subjects_info.csv"
data_dir = '/home/dadafly/program/SensePrivacy/MobiAct/data/mobiact/'
...
noise_data = np.random.uniform(-10, 10, [1, train_data.shape[1], train_data.shape[2], 1])
# noise_data = np.repeat(noise_data, num_train, axis=0)
#################################################################################
# load model
#################################################################################
...
lossnet = load_model('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/lossnet.h5')
...
gennet = load_model('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/gender_net.h5')
gennet.trainable = False
heinet = load_model('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/hei_net.h5')
heinet.trainable = False
weinet = load_model('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/wei_net.h5')
weinet.trainable = False
agenet = load_model('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/age_net.h5')
agenet.trainable = False
idnet = load_model('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/id_net.h5')
...
for i in range(num_of_epochs):
	...
	transnet.save('/home/dadafly/program/SensePrivacy/MobiAct/saved_model/style_weight_'+str(int(style_weight*100))+'/transnet_'+str(i+1)+'.h5')
	#######################################################################################3
